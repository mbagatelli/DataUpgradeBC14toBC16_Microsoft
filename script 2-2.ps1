...
$DatabaseName         = "GTOGHERMIGRATEDB_14to16_WORKV5" 
$ServiceName          = "BC160"
...
Write-Host "17. Pausing for 4 minutes"
...
Write-Host "20. Synchronize the newly published extensions using the Sync-NAVApp cmdlet like you did in previous steps."
...
Start-NAVAppDataUpgrade -ServerInstance $ServiceName -Name "MicrosoftBC14toBC16" -version 1.0.0.1
...
Start-NAVAppDataUpgrade -ServerInstance $ServiceName -Name "BC14toBC15" -Version 1.0.0.1
...
Unpublish-NAVApp -ServerInstance $ServiceName -Name "BC14toBC15" -Version 1.0.0.0
Unpublish-NAVApp -ServerInstance $ServiceName -Name "MicrosoftBC14toBC16" -Version 1.0.0.0
...
Install-NAVApp -ServerInstance $ServerInstance -Name "Application" -Version 16.5.15897.15953
